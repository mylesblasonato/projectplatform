...
namespace UltEvents
{
    ...
    public static class UltEventUtils
    {
        ...
        /// <summary>Returns the full name of a `member` as it would appear in C# code.</summary>
        /// <remarks>
        /// For example, passing this method info in as its own parameter would return
        /// "<see cref="UltEventUtils"/>.GetNameCS".
        /// <para></para>
        /// Note that when `member` is a <see cref="Type"/>, this method calls
        /// <see cref="GetNameCS(Type, bool)"/> instead.
        /// </remarks>
        ...
        /// <summary>Appends the full name of a `member` as it would appear in C# code.</summary>
        /// <remarks>
        ...
        public static string DeepToString(this IEnumerable collection, string separator)
            => collection == null
            ? "null"
            : collection.GetEnumerator().DeepToString(separator);
        ...
        public static string DeepToString(this IEnumerable collection)
            => collection.DeepToString(Environment.NewLine);
        ...
        /// for regular methods or <see cref="FieldInfo.FieldType"/> for fields.
        /// </summary>
        ...
        /// <summary>Returns "AssemblyQualifiedName.MemberName".</summary>
        public static string GetFullyQualifiedName(MemberInfo member)
            => $"{member.DeclaringType.AssemblyQualifiedName}.{member.Name}";
        ...
        /// </summary>
        public static void StableInsertionSort<T>(IList<T> list)
