...
{
    /// <summary>
    /// Allows you to expose the add and remove methods of an <see cref="UltEvent{T0, T1, T2}"/>
    ...
    public interface IUltEvent<T0, T1, T2> : IUltEventBase
    {
        ...
        /// </summary>
        void Invoke(T0 parameter0, T1 parameter1, T2 parameter2);

        /************************************************************************************************************************/
    }

    /// <summary>A serializable event with 3 parameters which can be viewed and configured in the inspector.</summary>
    /// <remarks>This is a more versatile and user friendly implementation than <see cref="UnityEvent{T0, T1, T2}"/>.</remarks>
    [Serializable]
    public class UltEvent<T0, T1, T2> : UltEventBase, IUltEvent<T0, T1, T2>
    {
        ...
        /// </summary>
        public static UltEvent<T0, T1, T2> operator +(UltEvent<T0, T1, T2> ultEvent, Action<T0, T1, T2> method)
        {
            ultEvent ??= new UltEvent<T0, T1, T2>();
        ...
        public static implicit operator UltEvent<T0, T1, T2>(Action<T0, T1, T2> method)
        {
            ...
            var ultEvent = new UltEvent<T0, T1, T2>();
            ultEvent += method;
            return ultEvent;
        }
        ...
        public static void AddDynamicCall(ref UltEvent<T0, T1, T2> ultEvent, Action<T0, T1, T2> method)
        {
            ultEvent ??= new UltEvent<T0, T1, T2>();
        ...
        public static void RemoveDynamicCall(ref UltEvent<T0, T1, T2> ultEvent, Action<T0, T1, T2> method)
        {
            if (ultEvent != null)
                ultEvent.DynamicCalls -= method;
        }
        ...
        public virtual void Invoke(T0 parameter0, T1 parameter1, T2 parameter2)
        {
            ...
            _DynamicCalls?.Invoke(parameter0, parameter1, parameter2);
        }
